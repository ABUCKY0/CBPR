(function() {
  ...
  function Runner(outerContainerId, opt_config) {
    ...
    this.savedProgress = !!window.localStorage.getItem("dino")? JSON.parse(window.localStorage.getItem("dino")) : false;
    this.distanceRan = this.savedProgress
      ? this.savedProgress.distance
      : 0;
    // this.distanceRan = 0;
    this.highestScore = 0;
    this.time = 0;
    ...
    this.currentSpeed = this.savedProgress ? this.savedProgress.speed : 6;
    //this.currentSpeed = 6;
    this.obstacles = [];
    this.started = false;
  ...
  Runner.save = function() {
    //console.log({"distance": Runner.distanceRan, "speed": Runner.currentSpeed});
  ...
  DistanceMeter.prototype = {
    ...
    update: function(deltaTime, distance) {
      //console.log(this.getActualDistance(distance));
      var paint = true;
      var playSound = false;
      if (!this.acheivement) {
